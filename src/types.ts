...
export interface PackageBuild { id:string; title:string; author:string; description:string; details?:string; category:string; license:string; homepage?:string; binary?:string; appCreated?:string; app_dls?:number; source?:string; channels?:Channel[]; compatibility?:Compatibility; related?:string[]; }
...
export interface InstallRule { from:string; to:string; exclude?:string[]; mode?:'overwrite'|'if-missing'; local?:string; }
export interface GithubChangelogHistory { owner:string; repo:string; path:string; branch?:string; commits?:number; }
export interface ChangelogSource { type?:'file'|'github-commits'; url?:string; section?:'future'|'version'; owner?:string; repo?:string; branch?:string; commits?:number; history?:number; previousReleases?:number; githubHistory?:GithubChangelogHistory; excludeFile?:string; }
